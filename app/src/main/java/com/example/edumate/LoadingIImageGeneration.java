...
public class LoadingIImageGeneration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loading_iimage_generation);

        String extractedText = getIntent().getStringExtra("EXTRACTED_TEXT");
        chatGPT(extractedText);
...
//                            textView.setText(responseText);
                            ...
                            TextView check = findViewById(R.id.loadingImageGenTextView);
                            check.setText("done...");
                            test(responseText);
            ...
            call.enqueue(new Callback<ResponseBody>() {
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    if (response.isSuccessful()) {
                        TextView check = findViewById(R.id.loadingImageGenTextView);
                        check.setText("done");
                        Intent intent = new Intent(LoadingIImageGeneration.this, QuizActivity.class);
